...
Material *SceneParser::parseMaterial() {
    ...
    auto *answer = new Material(filename,diffuseColor, specularColor,Energy, shininess,type,ns,textureFunc);
    return answer;
}
...
Object3D *SceneParser::parseObject(char token[MAX_PARSER_TOKEN_LENGTH]) {
    ...
    if (!strcmp(token, "Group")) {
        ...
        // std::cout<<"revsurface1"<<std::endl;
        answer = (Object3D *) parseRevSurface();
        // std::cout<<"revsurface2"<<std::endl;
    } else {
